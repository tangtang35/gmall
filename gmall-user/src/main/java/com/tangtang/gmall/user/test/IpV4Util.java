...
public class IpV4Util
{
     ...
     * @param
     *
     * "255.255.254.0"等格式，如果格式不合法，抛出UnknownError异常错误
     */
    ...
    public static void main(String[] args) throws UnknownHostException
    {
        ...
        String str = (now.get(Calendar.MINUTE)+10)+" "+now.get(Calendar.HOUR_OF_DAY)+" "+now.get(Calendar.DAY_OF_MONTH)+" "+(now.get(Calendar.MONTH) + 1);
        String aa = str+" * sh /home/dm/service/WEB-INF/classes/client/factory_restore.sh";



        String[] cmdStrArr = {"/bin/sh", "-c", "asdasd"};
        System. out.println(aa);

        String ip1 = "200.200.210.240";
        String ip2 = "200.200.211.254";
        int mask1 = getIpV4Value( "255.255.252.0");

        boolean boo = checkSameSegment(ip1, ip2, mask1);
        System. out.println("ip1和ip2在同一个网段中？ " + (checkSameSegment(ip1, ip2, mask1)));

        // 判断ip两个地址的大小关系
        /*String ip1 = "172.19.1.65";
        String ip2 = "172.18.1.66";
